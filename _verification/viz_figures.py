...
VIZ_FIGURES = [
    ...
    {"code": "2.1.f1", "module": "interactive_equation", "index": 2, "facts": [("2*4", "8")]},
    {"code": "2.2.f1", "module": "bar_models", "index": 2, "facts": [("2*4+3", "11")]},
    {"code": "2.2.f2", "module": "annotated_examples", "index": 0, "facts": [("2*4+3", "11")]},
    {"code": "2.3.f1", "module": "area_models", "index": 3, "facts": [("2*x+3*x", "5*x")]},
    {"code": "2.3.f2", "module": "area_models", "index": 0, "facts": [("2*(x+4)", "2*x+8")]},
    {"code": "2.4.f1", "module": "flowcharts", "index": 1, "facts": [("3*(2+2)", "2+10")]},
    ...
    {"code": "3.2.f1", "module": "double_number_lines", "index": 1, "facts": [("3/2", "6/4"), ("6/4", "9/6")]},
    ...
    {"code": "5.1.f2", "module": "interactive_graph", "index": 1, "facts": []},
    ...
    {"code": "6.2.f1", "module": "bar_models", "index": 3, "facts": [("6+11", "17"), ("11-6", "5")]},
    ...
    {"code": "12.3.f2", "module": "example_graphs", "index": 1, "facts": [("(-2)**2-(-2)-6", "0"), ("3**2-3-6", "0")]},
    {"code": "12.4.f1", "module": "area_models", "index": 4, "facts": [("x**2+6*x", "(x+3)**2-9")]},
    ...
    {"code": "A.3.f1", "module": "stats_charts", "index": 2, "facts": []},
]
