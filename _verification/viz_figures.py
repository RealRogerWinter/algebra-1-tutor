...
VIZ_FIGURES = [
    ...
    {"code": "2.5.f2", "module": "fractions", "index": 0, "facts": []},
    {"code": "2.5.f3", "module": "fractions", "index": 1, "facts": [("3/4", "6/8")]},
    {"code": "2.5.f4", "module": "fractions", "index": 2, "facts": [("6/8", "3/4")]},
    {"code": "2.5.f5", "module": "fractions", "index": 3, "facts": [("3/4", "9/12"), ("1/6", "2/12")]},
    {"code": "2.5.f6", "module": "fractions", "index": 4, "facts": [("(1/2)*(2/3)", "1/3")]},
    {"code": "2.5.f7", "module": "fractions", "index": 5, "facts": [("(2/3)*(3/2)", "1")]},
