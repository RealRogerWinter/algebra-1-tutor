...
<h2>Get the tutor</h2>
<p>The tutor is a free <b>Claude skill</b>. Download <a href="https://github.com/RealRogerWinter/algebra-1-tutor/raw/main/algebra-1-tutor.zip"><code>algebra-1-tutor.zip</code></a> and upload it in the Claude app or on claude.ai, and Claude becomes your Algebra 1 teacher with the whole book in front of it. The <a href="../textbook/how-to-use.html">how-to-use page</a> walks through setup and a first session step by step, and it works on the free plan.</p>
