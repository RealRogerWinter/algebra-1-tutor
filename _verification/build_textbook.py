...
ul.units{list-style:none;padding:0}ul.units li{margin:.4rem 0}.u{color:var(--muted);font-size:.9em}ul.units .u{font-size:.85em}
section.ug{margin:1.2rem 0;padding-bottom:.6rem;border-bottom:1px solid var(--rule)}section.ug h3{margin:.2rem 0}
