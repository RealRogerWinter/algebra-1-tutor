...
**Answer key:**
1. \(x + 5\) · 2. \(2x\) · 3. \(x - 3\) (not \(3 - x\)) · 4. \(2x + 7\) · 5. \(\dfrac{x}{4}\) · 6. \(3x - 6\) (not \(6 - 3x\))
7. \(x + 12 = 20 \Rightarrow x = 8\)
8. \(4x - 7 = 9 \Rightarrow x = 4\)
9. \(2x + 7 = 23 \Rightarrow x = 8\)
10. \(x - 3 = 10 \Rightarrow x = 13\)
11. \(3x = 21 \Rightarrow x = 7\)
12. \(\dfrac{x}{2} + 5 = 11 \Rightarrow x = 12\)
13. \(5x - 4 = 26 \Rightarrow x = 6\)
14. \(2(x + 3) = 16 \Rightarrow x = 5\)
15. \(x + 8 = 3x \Rightarrow x = 4\)
...
**New terms:**
- **Consecutive integers:** integers in a row, each one more than the last: \(n,\; n+1,\; n+2,\dots\) For consecutive **even** or **odd** integers, the gap is 2: \(n,\; n+2,\; n+4,\dots\)
...
3 hours. Check: \(60 \times 3 = 180\) miles.
...
**Answer key:**
1. \(n + (n+1) = 47 \Rightarrow n = 23\): the integers are **23 and 24**. Check \(23 + 24 = 47\).
2. \(n + (n+2) = 56 \Rightarrow n = 27\): **27 and 29** (both odd). Check \(27 + 29 = 56\).
3. Let brother \(= b\), Maya \(= b + 5\): \(b + (b+5) = 33 \Rightarrow b = 14\). Brother **14**, Maya **19**. Check \(14 + 19 = 33\).
4. Let daughter \(= d\), mother \(= 4d\); difference 18: \(4d - d = 18 \Rightarrow d = 6\). Daughter **6**, mother **24**. Check \(24 - 6 = 18\) and \(24 = 4 \times 6\).
5. \(45t = 225 \Rightarrow t = 5\) hours. Check \(45 \times 5 = 225\).
6. \(r \cdot 4 = 220 \Rightarrow r = 55\) mph. Check \(55 \times 4 = 220\).
7. Let \(n =\) nickels, dimes \(= 20 - n\): \(0.05n + 0.10(20 - n) = 1.55 \Rightarrow n = 9\). **9 nickels, 11 dimes**. Check \(9(0.05) + 11(0.10) = 0.45 + 1.10 = \$1.55\).
8. Let \(w =\) width, length \(= w + 5\): \(2\big(w + (w+5)\big) = 46 \Rightarrow w = 9\). Width **9**, length **14**. Check perimeter \(2(9 + 14) = 46\).
...
**Visuals to offer:** `visuals.md` — coordinate plane with plotted points (SVG artifact). Below is a ready scatter plot with **computed** screen coordinates (hours studied \(x\) vs. quiz score \(y\); map \(s_x = 40 + 30x\), \(s_y = 170 - 1.4y\)), including a best-fit line \(y = 7x + 50\) drawn from its computed endpoints \((0,50)\) and \((6,92)\). Always pair it with the table of points in chat.
