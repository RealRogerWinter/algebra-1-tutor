...
2. **Inverse operations, named honestly.** Avoid the word "cancel." Say a term **"goes to zero"** (for \(+/-\)) or **"goes to one"** (for \(\times/\div\)) — that's literally what happens, and it heads off the misconception that symbols just vanish by magic (misconceptions.md §1).
...
**Naming the move honestly:** When we subtract 5 from \(x+5\), the \(+5\) **goes to zero** — \(x\) is left alone. For \(4x=20\), dividing both sides by 4 makes the coefficient **go to one** (\(\tfrac{4}{4}=1\), and \(1x=x\)). Avoid "cancel" (misconceptions.md §1).
...
- Reading \(=\) as "the answer goes here" rather than balance (misconceptions.md §1) — surfaces on \(x+7=7\) and \(x-8=0\). Hinge question: "Fill the blank so this stays true: \(8+4=\square+5\)."
...
16. \(\dfrac{x}{2}=6\)  17. \(\dfrac{x}{3}=4\)  18. \(\dfrac{x}{5}=2\)  19. \(\dfrac{x}{4}=8\)  20. \(\dfrac{x}{6}=3\)

*Mixed (pick the right inverse):*
21. \(x+14=23\)  22. \(9x=54\)  23. \(x-7=15\)  24. \(\dfrac{x}{8}=3\)  25. \(x+6=19\)
...
**Teaching arc (concrete → pictorial → symbolic):**
- *Metaphor (getting dressed, metaphors.md → Equations B):* To build \(2x+3\) from \(x\) you *multiply by 2, then add 3* — socks, then shoes. To undo it, reverse both the order and the action: **shoes off first** (subtract 3), **then socks** (divide by 2). That's why we strip the \(+/-\) before the \(\times/\div\).
...
Ask first: "We have a \(\times 2\) and a \(+3\) wrapped around \(x\). Which layer is on the *outside* — which do we peel first?"
...
Narrate the sign: \(-2x=6\), divide both sides by \(-2\); \(\tfrac{6}{-2}=-3\). The check is where a sign slip would get caught — \(8-2(-3)\) uses subtracting a negative (metaphors.md → negatives; misconceptions.md §3).
...
**Visuals to offer:** none needed; the \(\xrightarrow{}\) step notation is the visual.
...
*Division type:*
9. \(\dfrac{x}{2}+3=8\)  10. \(\dfrac{x}{4}-1=2\)  11. \(\dfrac{x}{3}+5=9\)  12. \(\dfrac{x}{5}-2=0\)
...
- *Distributing a negative — the big one:* A leading minus is a \(-1\) shaking hands with **everyone** inside. \(-(x-4)\): the \(-1\) meets \(x\) (giving \(-x\)) **and** meets \(-4\) (giving \(+4\), because \(-1 \times -4 = +4\)). So \(-(x-4)=-x+4\), **not** \(-x-4\) (misconceptions.md §3). Verify by substituting \(x=1\): original \(-(1-4)=-(-3)=3\); rewrite \(-1+4=3\).
...
Check at \(x=1\): original \(3-2(1-5)=3-2(-4)=3+8=11\); rewrite \(-2(1)+13=11\). (Common wrong answer: \(3-2x-10=-2x-7\) from giving \(-2 \times -5\) a minus sign.)
...
3. "A student writes \(4-2(x+3)=4-2x+6\). Where exactly did it go wrong?" (the \(-2\times 3\) should be \(-6\))
...
> **Teach the refreshers first if there's any hesitation** — surface them with the placement-style question \(\tfrac{2}{3}x=6\). If the student is already fluent with fractions, skip straight to the lesson proper (pedagogy.md → don't make a confident student crawl).

### Fraction Refresher A — Common Denominators

**The idea:** You can only add **same-sized pieces**. Thirds and quarters aren't the same size, so first rename both as a common size, *then* add the numerators (the count of pieces). Tie it to **magnitude**: \(\tfrac{1}{6}<\tfrac{1}{4}\) — splitting a pizza among 6 gives *smaller* slices than among 4 (misconceptions.md §4). And never add across (\(\tfrac{1}{2}+\tfrac{1}{3}\neq\tfrac{2}{5}\)).

**Finding a common denominator:**
- *Bulletproof:* multiply the denominators (\(4\) and \(6\to 24\)) — always works, may need reducing.
- *Cleaner:* use the **LCM** (least common multiple) of the denominators (\(4\) and \(6\to 12\)).
...
1. \(\dfrac14+\dfrac24\)  2. \(\dfrac13+\dfrac16\)  3. \(\dfrac12+\dfrac14\)  4. \(\dfrac23+\dfrac14\)  5. \(\dfrac34-\dfrac12\)  6. \(\dfrac56-\dfrac13\)  7. \(\dfrac12+\dfrac15\)  8. \(\dfrac38+\dfrac14\)  9. \(\dfrac23-\dfrac16\)  10. \(\dfrac12+\dfrac13+\dfrac16\)

**Key (verified):** 1) \(\tfrac34\)  2) \(\tfrac12\)  3) \(\tfrac34\)  4) \(\tfrac{11}{12}\)  5) \(\tfrac14\)  6) \(\tfrac12\)  7) \(\tfrac{7}{10}\)  8) \(\tfrac58\)  9) \(\tfrac12\)  10) \(1\)

### Fraction Refresher B — Reciprocals

**The idea:** The **reciprocal** of a fraction is the fraction flipped, and a number times its reciprocal **goes to one**: \(\tfrac23 \times \tfrac32 = 1\). A whole number is "over 1," so its reciprocal flips too: \(5=\tfrac51 \to \tfrac15\). **To undo multiplication by a fraction, multiply by its reciprocal** — that's the inverse operation for a fraction coefficient. So \(\tfrac23 x=6\) is solved by multiplying both sides by \(\tfrac32\).

**Worked:**
$$\frac23 x = 6 \;\xrightarrow{\,\times \frac32\,}\; x = 6\cdot\frac32 = 9 \qquad \text{Check: } \frac23(9)=6$$

**Practice — name the reciprocal:**
1. \(\dfrac58\)  2. \(\dfrac19\)  3. \(6\)  4. \(\dfrac{11}{4}\)

**Practice — solve using a reciprocal:**
5. \(\dfrac12 x=7\)  6. \(\dfrac25 x=4\)  7. \(\dfrac34 x=6\)  8. \(\dfrac23 x=10\)  9. \(\dfrac56 x=5\)  10. \(\dfrac32 x=9\)

**Key (verified):** 1) \(\tfrac85\)  2) \(9\)  3) \(\tfrac16\)  4) \(\tfrac{4}{11}\)  5) \(14\)  6) \(10\)  7) \(8\)  8) \(15\)  9) \(6\)  10) \(6\)
...
**Watch for:**
- **Multiplying only some terms** when clearing fractions (forgetting the constant or the right side). Repair: "Every term gets the \(\times 6\) — the scale only stays level if *both whole pans* are multiplied."
- **Flipping the wrong thing / not flipping:** dividing by \(\tfrac23\) instead of multiplying by \(\tfrac32\). Both are valid, but the reciprocal is cleaner; show they agree.
- **Adding-across error** resurfacing (\(\tfrac{x}{2}+\tfrac{x}{3}\to \tfrac{x}{5}\), misconceptions.md §4). Repair via Refresher A: different-sized pieces.
- **Fraction magnitude** confusion (\(\tfrac32 x\) feels "less than \(x\)"). Tie back to the number line (misconceptions.md §4).

**Visuals to offer:** none needed; an ASCII number line can anchor a magnitude question (\(\tfrac32\) sits past 1) if the student doubts it.

**Check for understanding (transfer):**
1. "Solve \(\tfrac25 x=8\) two ways — by reciprocal, and by multiplying through by 5 — and confirm they agree."
2. "In \(\tfrac{x}{2}+\tfrac{x}{4}=6\), what number clears *both* fractions, and why that one?"
3. "Why does multiplying by \(\tfrac32\) make \(\tfrac23 x\) *go to one* times \(x\)?"

**Practice problems:**

*Reciprocal method (single fraction coefficient):*
1. \(\dfrac12 x=5\)  2. \(\dfrac23 x=8\)  3. \(\dfrac35 x=9\)  4. \(\dfrac52 x=10\)

*Clear the fractions (common denominator):*
5. \(\dfrac{x}{2}+\dfrac{x}{4}=6\)  6. \(\dfrac{x}{3}+\dfrac{x}{6}=3\)  7. \(\dfrac{x}{2}-\dfrac{x}{5}=3\)  9. \(\dfrac{x}{4}+\dfrac{x}{2}=9\)

*Mixed (fraction coefficient with a constant):*
8. \(\dfrac23 x+1=7\)  10. \(\dfrac34 x-2=4\)

**Answer key (all verified):**
1) \(10\)  2) \(12\)  3) \(15\)  4) \(4\)  5) \(8\)  6) \(6\)  7) \(10\)  8) \(9\)  9) \(12\)  10) \(8\)

*Substitution spot-checks:* #5: \(\tfrac{8}{2}+\tfrac{8}{4}=4+2=6\). #7: \(\tfrac{10}{2}-\tfrac{10}{5}=5-2=3\). #8: \(\tfrac23(9)+1=6+1=7\).
