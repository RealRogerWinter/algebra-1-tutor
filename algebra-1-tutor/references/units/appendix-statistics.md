...
- **Relative frequency:** a count expressed as a **fraction or percent of a total** — count/total. Which total (grand, row, or column) depends on the question.
...
- **Read a count:** people who own a pet **and** live in an apartment =12 (top-left cell).
- **Relative frequency (of everyone):** fraction who own a pet =30/50=3/5=60%.
- **Relative frequency (within a column):** of the 20 apartment dwellers, the fraction owning a pet =12/20=3/5=60%. (Note how the *total you divide by* changes with the question.)
