# Curriculum Map & Placement

The full Algebra 1 course, the order it's meant to flow in, and what each unit assumes. Use this to orient a new student, to let someone jump safely, and to run a quick placement check.

The spine is deliberately ordered so each idea rests on the one before it. But a motivated adult can jump anywhere — the **Assumes** line on each unit tells you what to spot-check or warm up first. Don't send someone back to Unit 1 to relearn everything; patch the specific gap and move on.
...
- 2.5 Equations with fractions (incl. Fraction Refreshers A: common denominators, B: reciprocals)

**Unit 3 — Proportional Reasoning**
- 3.1 Ratios and rates (unit rate = the seed of slope)
...
- 7.2 Substitution
- 7.3 Elimination
- 7.4 Special cases & applications
...
- 9.1 Arithmetic & geometric sequences as functions
- 9.2 Exponential growth & decay; linear vs. exponential

**Unit 10 — Exponents & Polynomials**
- 10.1 Exponent rules (incl. zero & negative)
- 10.2 Scientific notation
- 10.3 Polynomials: terms, degree, standard form; add & subtract
- 10.4 Multiplying polynomials (distributing, FOIL, area model)

**Unit 11 — Factoring**
- 11.1 Greatest common factor
- 11.2 Factoring trinomials
- 11.3 Special patterns (difference of squares, perfect-square trinomials)
...
## Placement check (use when a student isn't sure where they fit)
